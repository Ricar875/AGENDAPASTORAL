...
type CompromissoTipo = "visita" | "reuniao" | "pregacao" | "culto"
...
const compromissosIniciais: Compromisso[] = [
  ...
  },
  {
    id: "3",
    tipo: "culto",
    titulo: "Culto de quarta-feira",
    pessoa: "Congregação",
    local: "Templo Sede",
    data: "2026-07-08",
    hora: "19:30",
    observacoes: "Estudo bíblico temático",
    status: "pendente",
  },
  {
    id: "4",
    tipo: "pregacao",
    titulo: "Escala de pregação - Culto de domingo",
    pessoa: "Pr. João Silva",
    local: "Templo Sede",
    data: "2026-07-12",
    hora: "18:00",
    status: "pendente",
          ...
          <DialogContent className="sm:max-w-md">
            ...
            <div className="space-y-4 py-2">
              <div className="grid grid-cols-2 gap-2">
                ...
                <Button
                  type="button"
                  variant={novo.tipo === "culto" ? "default" : "outline"}
                  size="sm"
                  onClick={() => setNovo((n) => ({ ...n, tipo: "culto" }))}
                >
                  Culto
                </Button>
                <Button
                  type="button"
                  variant={novo.tipo === "pregacao" ? "default" : "outline"}
                  size="sm"
                  onClick={() => setNovo((n) => ({ ...n, tipo: "pregacao" }))}
                >
                  Escala de pregação
                </Button>
              </div>
            ...
            <CardContent className="flex items-start gap-3 py-4">
              ...
              <div className="flex-1 space-y-1">
                <div className="flex flex-wrap items-center gap-2">
                  ...
                  <Badge variant={c.tipo === "visita" || c.tipo === "culto" ? "default" : "secondary"}>
                    {c.tipo === "visita"
                      ? "Visita"
                      : c.tipo === "reuniao"
                        ? "Reunião"
